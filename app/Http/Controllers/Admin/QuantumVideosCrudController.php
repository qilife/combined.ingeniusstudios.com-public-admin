 ...
 */
class QuantumVideosCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\QuantumVideos::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/quantumvideos');

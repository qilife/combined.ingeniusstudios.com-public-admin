...
class CategoryCrudController extends CrudController
{
    ...
    protected function commonSetup() {
        ...
        CRUD::addField([
            'type'      => 'select',
            'name'      => 'tier_id', // the db column for the foreign key
        ]);
    }
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::removeColumns(['tier_id', 'headline', 'quote']);

        CRUD::addColumn([
            'type'      => 'relationship',
            'name'      => 'tier', // the db column for the foreign key
        ]);
        CRUD::addColumn([
            'type'  => 'boolean',
            'name'  => 'is_active',
    ...
    {
        return $this->commonStore(Category::max('order'));
    }

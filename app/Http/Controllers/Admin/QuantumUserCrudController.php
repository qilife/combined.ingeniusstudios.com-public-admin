 ...
 */
class QuantumUserCrudController extends UserCrudController
{
    ...
    {
        CRUD::setModel(\App\Models\QuantumUser::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/quantumuser');
    ...
    protected function setupListOperation()
    {
		...
		CRUD::removeColumn('apple_id');
		CRUD::removeColumn('phone');
    }
